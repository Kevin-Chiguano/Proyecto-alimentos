  ...
  return (
    <div className="blog-page">
      <h1 className="blog-title">
        <span className="blog-title-left">Tu donación, su futuro</span>
      </h1>
      <div className="content-container">
        <div className="text-section">
          ...
          <ul>
            <li><a href="https://www.baq.ec " target="_blank" rel="noopener noreferrer">Donar Alimentos</a></li>
        ...
        <div className="image-section">
          <img src="https://live.staticflickr.com/65535/52212749073_c9c7825e2a_z.jpg" alt="Voluntarios distribuyendo alimentos" className="blog-image" />
        </div>
        </div>
    </div>
  );
